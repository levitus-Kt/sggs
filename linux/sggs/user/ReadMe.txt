...
Главную папку (sggs) вместе с содержимым нужно положить в домашнюю директорию пользователя (НЕ root!)
...
Расписание звонков берется с сайта http:/shkarenkov.ru/1212/bells_time.txt. При необходимости сменить расписание, менять нужно именно там. 
...
Если в консоли запускается, а в systemctl - нет, значит, ты что-то пропустил.
